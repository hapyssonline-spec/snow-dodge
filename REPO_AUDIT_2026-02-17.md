...
1. **Несовпадение ассета в сервис-воркере** *(исправлено)*:
   - ссылка в `sw.js` приведена к `./assets/fish/karas.png`,
   - precache больше не содержит несуществующего файла.

2. **Документация по ассетам** *(обновлено)*:
   - удалены устаревшие упоминания неактуальных файлов,
   - список слоёв и файлов синхронизирован с репозиторием.

3. **Текстовые упоминания несуществующих страниц** *(очищено)*:
   - вводящие в заблуждение ссылки удалены из документации.
